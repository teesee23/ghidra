...
public class DecompilerSugiyamaLayoutProvider implements FGLayoutProvider {
	...
	public FGLayout getFGLayout(FunctionGraph graph, TaskMonitor monitor) {
		DecompilerSugiyamaLayout layout = new DecompilerSugiyamaLayout(graph);
